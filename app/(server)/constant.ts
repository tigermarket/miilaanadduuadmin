...
export const AvailableShippingMethods = Object.values(ShippingMethodEnum);
...
export const creditTypeEnum = {
  ...
  GRADUALPAY: "GRADUALPAY",
};

export const AvailablecreditTypes = Object.values(creditTypeEnum);
